...
class KingTest {
    ...
    fun `test king movement successful within one square`() {
        ...
        assertTrue(king.mv.validate(movement1, gameState) is SuccessfulMovementResult)
        assertTrue(king.mv.validate(movement2, gameState) is SuccessfulMovementResult)
        assertTrue(king.mv.validate(movement3, gameState) is SuccessfulMovementResult)
    }
