...
class ChancellorTest {
    ...
    fun `test chancellor movement successful with combined pattern`() {
        ...
        assertTrue(chancellor.mv.validate(movement1, gameState) is SuccessfulMovementResult)
        assertTrue(chancellor.mv.validate(movement2, gameState) is SuccessfulMovementResult)
        assertTrue(chancellor.mv.validate(movement3, gameState) is SuccessfulMovementResult)
        assertTrue(chancellor.mv.validate(movement4, gameState) is SuccessfulMovementResult)
    }
