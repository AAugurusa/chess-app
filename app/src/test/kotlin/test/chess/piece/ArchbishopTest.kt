...
class ArchbishopTest {
    ...
    fun `test archbishop movement successful with combined pattern`() {
        ...
        assertTrue(archbishop.mv.validate(movement1, gameState) is SuccessfulMovementResult)
        assertTrue(archbishop.mv.validate(movement2, gameState) is SuccessfulMovementResult)
        assertTrue(archbishop.mv.validate(movement3, gameState) is SuccessfulMovementResult)
        assertTrue(archbishop.mv.validate(movement4, gameState) is SuccessfulMovementResult)
    }
