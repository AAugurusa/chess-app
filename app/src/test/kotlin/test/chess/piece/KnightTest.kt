...
class KnightTest {
    ...
    fun `test knight movement successful with L-shaped pattern`() {
        ...
        assertTrue(knight.mv.validate(movement1, gameState) is SuccessfulMovementResult)
        assertTrue(knight.mv.validate(movement2, gameState) is SuccessfulMovementResult)
        assertTrue(knight.mv.validate(movement3, gameState) is SuccessfulMovementResult)
        assertTrue(knight.mv.validate(movement4, gameState) is SuccessfulMovementResult)
    }
    ...
    fun `test knight movement with obstacles`() {
        ...
        assertTrue(knight.mv.validate(movement, gameState) is SuccessfulMovementResult)
    }
}
