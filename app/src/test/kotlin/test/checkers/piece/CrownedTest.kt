...
class CrownedTest {
    ...
    fun `test crowned checker movement successful with valid pattern`() {
        ...
        assertTrue(crownedChecker.mv.validate(movement1, gameState) is SuccessfulMovementResult)
        assertTrue(crownedChecker.mv.validate(movement2, gameState) is SuccessfulMovementResult)
    }
    ...
    fun `test crowned checker capture successful`() {
        ...
        assertTrue(crownedChecker.mv.validate(captureMovement, gameState) is SuccessfulMovementResult)
    }
